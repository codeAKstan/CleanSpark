  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-white">
      <div className="text-center mb-12">
        <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900">Why CleanSpark?</h2>
        <p className="text-gray-500 mt-4 max-w-2xl mx-auto">
          We&apos;re more than just a solar company. We are your partner in building
          a sustainable and reliable future.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {features.map((feature, index) => (
          <div
            key={index}
            className="bg-white p-6 pb-2 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center"
          >
